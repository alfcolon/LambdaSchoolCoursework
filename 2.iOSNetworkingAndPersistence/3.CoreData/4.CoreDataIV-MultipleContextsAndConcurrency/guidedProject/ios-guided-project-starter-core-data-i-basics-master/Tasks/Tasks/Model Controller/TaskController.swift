...
class TaskController {
    ...
    let baseURL: URL! = URL(string: "https://tasks-d3884.firebaseio.com/classDatabaseCopy")
    ...
    func sendTaskToServer(task: Task, completion: @escaping CompletetionHandler = { _ in })
    {
        ...
        //https://tasks-d3884.firebaseio.com/classDatabaseCopy/[uuid].json
    ...
    private func updateTasks(with representations: [TaskRepresentation]) throws {
        ...
        //Avoid this because the main thread cannot be accessed from a background thread
